...
- Source artifact: `cgo_harness/harness_out/tier_scan_parallel/current-206-smoke-20260625/merged`
- Machine-readable ledger: `docs/reports/206-residual-frame-domain-ledger-20260625.tsv`
- Rows: 60 (59 current Tier IV residuals plus 1 unmeasured)
- True-coding high-priority rows: 27
...
| config_build | 11 |
| data_grammar | 5 |
| markup_template_style | 7 |
| other | 2 |
| prose_docs | 4 |
| query_policy | 4 |
| true_programming_language | 27 |

## Top Next Machinery Lanes

| Next generalized machinery target | Count |
| --- | ---: |
| `glr_frontier_survival_and_reuse_selection` | 34 |
| `generalized_recovery_shape_and_cost` | 11 |
| `generalized_materialization_invariant` | 6 |
| `generalized_recovery_shape_and_terminal_timeout_accounting` | 3 |
...
| objc | `recovery_error_cost/error_tree_or_root_error` | objc-true-coding-recovery-n40-20260625 recertifies recovery_error_cost plus accepted_divergence_cost: 25/40 parity, 15 diverge, 0 trunc, 19 errTree, stopReason=accepted, no panics or failed files | `generalized_recovery_shape_and_cost` |
...
| fsharp | `accepted_shape_materialization/accepted_diverge` | coding-accepted-shape-n40-20260625 reclassifies stale pre-patch accepted-shape smoke row as terminal C-oracle timeout/fail evidence plus parser recovery_error_cost: 0/40 parity, 29 trunc, 12 errTree, terminal timeout:c_parse_start; timeout/fail is tracked separately from parser materialization | `generalized_recovery_shape_and_cost` |
| odin | `recovery_error_cost/error_tree_or_root_error` | odin-true-coding-recovery-n40-20260625 recertifies terminal_timeout_or_fail plus recovery_error_cost: 21/40 parity, 19 diverge, 3 trunc, 15 errTree, no panics, 1 failed file; terminal status timeout:go_parse_start:rc=124 | `generalized_recovery_shape_and_terminal_timeout_accounting` |
| wolfram | `recovery_error_cost/error_tree_or_root_error` | wolfram-true-coding-recovery-n40-20260625 completed available-corpus coverage only: 0/11 parity, 11 diverge, 0 trunc, 8 errTree, no panics, 3 failed files; terminal status timeout:go_parse_start:rc=124 repeated 3 times | `generalized_recovery_shape_and_terminal_timeout_accounting` |
| pascal | `recovery_error_cost/error_tree_or_root_error` | pascal-true-coding-recovery-n40-20260625 recertifies runtime_frontier_stop plus recovery_error_cost: 0/40 parity, 40 diverge, 6 trunc, 36 errTree, stopReason=accepted/memory_budget/no_stacks_alive, no panics or failed files | `glr_frontier_survival_and_reuse_selection` |
