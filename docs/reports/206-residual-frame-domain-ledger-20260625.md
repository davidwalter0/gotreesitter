...
| odin | `recovery_error_cost/error_tree_or_root_error` | current_smoke_only | `generalized_recovery_shape_and_cost` |
| wolfram | `recovery_error_cost/error_tree_or_root_error` | current_smoke_only | `generalized_recovery_shape_and_cost` |
