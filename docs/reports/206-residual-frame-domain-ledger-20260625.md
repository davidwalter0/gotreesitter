...
| `generalized_materialization_invariant` | 11 |
...
| purescript | `accepted_shape_materialization/accepted_diverge` | current_smoke_only | `generalized_materialization_invariant` |
